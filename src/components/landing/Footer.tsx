          ...
          <div className="grid grid-cols-1 w-full gap-5 md:grid-cols-3 lg:grid-cols-4">
            <div className="space-y-5">
              ...
              <p className='hidden md:inline-block'>
                WasteWorth: Since 2023, 
                expert recycling team building 
              ...
              <ul className="flex items-center space-x-4">
                ...
                <a href='https://www.instagram.com/invites/contact/?igsh=14z9s7ad5qx0k&utm_content=zgybkxn' target='_blank'>
                  <FaInstagram size={26}/>
                </a>
              </ul>
            </div>
