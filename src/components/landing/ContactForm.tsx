      ...
      <div>
        <div className="space-y-7">
          ...
          <form className="flex flex-col space-y-6">
            ...
            <div className="w-full ">
              <textarea
                className="appearance-none block w-full text-xs sm:text-sm text-gray-700 border border-gray-500 rounded py-3 px-2 sm:px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-green-600"
                id="message"
                placeholder="Message*"
              />
            </div>
