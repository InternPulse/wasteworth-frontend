    ...
    <section className="w-full py-5 bg-white rounded-md">
      <div className="space-y-10 px-3 sm:px-5">
        <div className="flex items-center justify-left">
          <h2 className="text-3xl rounded-full bg-white border border-green-700 w-20 h-20 px-7 py-5">
            G
          </h2>
        </div>
        <form
          onSubmit={handleSubmit(submit)}
          className="flex flex-col space-y-3 w-full font-semibold"
        >
          <div className="md:flex items-center space-x-20 w-full space-y-3">
            <div className="w-full">
              ...
              <input
                ...
                name="last_name"
                id="last-name"
                className="border border-gray-400 outline-green-500 w-full py-2 px-3 rounded-md mt-2"
              />
              {errors.last_name && (
          ...
          <div className="flex flex-col space-y-2">
            ...
            <input
              ...
              name="address"
              id="address"
              className="border border-gray-400 outline-green-500 w-full py-2 px-3 rounded-md"
            />
            {errors.address && (
