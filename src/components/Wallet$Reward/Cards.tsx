...
const Cards = () => {
    ...
    const cardDetails = [ 
        { id: 1, title: "Eco Points" , icon: assets.points, number: 400, bgColor: "#FFEFDA"},
        { id: 2, title: "Airtime Tokens" , icon: assets.token, number: 6, bgColor: "#F4F4F4"},
        { id: 3, title: "Wallet Balance" , icon: assets.balance, number: "coming soon", bgColor: "#F5F5F5"},
    ];
  ...
  return (
    ...
    <div key={card.id}  style={{ backgroundColor: card.bgColor }} className="h-35 flex flex-col justify-center gap-2 rounded-md px-5">
        ...
        <div className="flex justify-between items-center align-center ">
            ...
            <span className="w-8"> <img src={card.icon}  sizes="1" alt="token icon" /></span>
        </div>
