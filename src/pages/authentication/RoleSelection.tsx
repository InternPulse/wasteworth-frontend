...
const RoleSelection = () => {
  ...
  return (
    <div className="my-auto h-90 rounded-xl sm:rounded-xl w-9/10 sm:w-lg p-5 sm:py-15 bg-white text-black flex flex-col justify-center space-y-2">
      ...
      <p className="text-xs max-w-sm mx-auto sm:text-sm text-center text-gray-700">
        Choose the path that fits you best. Don't worry - you can always switch
        later
      </p>
        ...
        >
          ...
          <div
            className={`rounded-full h-4 w-4 border-2 border-gray-300 flex items-center justify-center ${
              role === "disposer" ? "border-none bg-green-700" : "hidden"
            }`}
          >
